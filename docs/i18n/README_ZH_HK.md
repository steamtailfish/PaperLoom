...
<table>
  <tr>
    <td width="50%" valign="top"><strong>🎨 以圖表說故事</strong><br>文獻綜述分區塊呈現，技術以流程圖及機制圖說明，實驗保留方便精確讀取的原生表格與圖表。</td>
  ...
  <tr>
    <td width="50%" valign="top"><strong>🔎 證據放在備忘稿</strong><br>來源與詳細證據放在演講者備忘稿；頁面底部只保留簡約裝飾與頁碼。</td>
...
<table>
  <tr>
    <th width="33%">文獻綜述</th>
    <th width="33%">技術與公式</th>
    <th width="33%">實驗</th>
  </tr>
  <tr>
    <td><a href="../../examples/layout-demo/preview-01.png"><img src="../../examples/layout-demo/preview-01.png" alt="文獻綜述" width="100%"></a></td>
    <td><a href="../../examples/layout-demo/preview-02.png"><img src="../../examples/layout-demo/preview-02.png" alt="技術與公式" width="100%"></a></td>
    <td><a href="../../examples/layout-demo/preview-03.png"><img src="../../examples/layout-demo/preview-03.png" alt="實驗" width="100%"></a></td>
  </tr>
</table>

[可編輯 PPTX](../../examples/layout-demo/layout-demo.pptx) · [原始碼與重現步驟](../../examples/layout-demo/README.md)
...
**將包含必要字型的完整專案目錄壓縮成 ZIP**，與論文 PDF 一併上載，然後傳送：

```text
請解壓縮我上載的 PaperLoom，先閱讀 SKILL.md，再按照當中的要求，為這篇論文製作科研組會議
PowerPoint。預設問題 1 頁、綜述 1 頁、技術 3–5 頁、實驗 2 頁、總結 1 頁。綜述以區塊呈現
，以圖表為先，使用套件內的仿宋 GB2312 和 Times New Roman；直接擷取論文圖片，將關鍵公式轉
換為 PowerPoint 原生公式。證據放在備忘稿，不要以小字放在來源頁尾。請實際產生並檢查 .pptx
。
```
...
3. **先安排敘事，再安排頁面**：從現有問題到綜述，再到技術、實驗與總結；按實際工作量分配技術頁數。
...
6. **按回饋作局部修改**：刪除來源頁尾，保留備忘稿；將綜述表格改為分區塊呈現；確保其他頁面與格式修復不會被還原。
